    ...
    <div>
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <span className="text-sm">
          Tip: Press{" "}
          <kbd className="border rounded-sm border-gray-200 bg-gray-100 px-2 py-1.5 text-xs font-semibold text-gray-800 dark:bg-gray-900 dark:border-gray-800 dark:text-gray-100">
            Ctrl + L
          </kbd>{" "}
          for AI autocomplete
        </span>
